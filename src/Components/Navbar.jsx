    ...
    return (
        <>
            ...
            <div>
                ...
                <ul className={nav ? 'hidden lg:flex lg:whitespace-nowrap text-center z-50 text-2xl items-center justify-center fixed top-[60px] p-3 left-0 w-full text-black bg-white' : 'hidden items-center justify-center lg:flex lg:whitespace-nowrap text-center z-10 text-2xl fixed top-[60px] p-3 left-0 w-full text-white'}>
